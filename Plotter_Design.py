...
# Form implementation generated from reading ui file 'C:\Users\anbil\Desktop\FOSSEE\plotter\Plotter Design.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabObject.setGeometry(QtCore.QRect(14, 49, 471, 551))
        font = QtGui.QFont()
        font.setFamily("MS Sans Serif")
        font.setPointSize(10)
        ...
        self.tableView.setGeometry(QtCore.QRect(5, 1, 451, 511))
        ...
        self.plotScatter.setGeometry(QtCore.QRect(-1, -1, 461, 521))
        ...
        self.widget = plotSmooth(self.smooth)
        self.widget.setGeometry(QtCore.QRect(-1, -1, 461, 521))
        self.widget.setObjectName("widget")
        self.tabObject.addTab(self.smooth, "")
        self.lines = QtWidgets.QWidget()
        self.lines.setObjectName("lines")
        self.widget_2 = plotLines(self.lines)
        self.widget_2.setGeometry(QtCore.QRect(-1, -1, 461, 521))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.editCheck.setGeometry(QtCore.QRect(10, 20, 101, 21))
        ...
        self.tabObject.setCurrentIndex(3)
